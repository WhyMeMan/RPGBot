...
public abstract class PircBot implements ReplyConstants {
    ...
    /**
     * Method used in order to obtain the class reference for a specific user by their nick.
     * @param channel The channel that you want to search for a user.
     * @param name The nick of the user that you are searching for.
     * @return Returns the class reference of the user.
     */
    protected User getUserByName(String channel, String name)
    {
    ...
    private String _name = "Loludumb";
    private String _nick = _name;
    private String _login = "Loludumb";
    private String _version = "Loludumb " + VERSION + " Java IRC Bot - www.jibble.org";
