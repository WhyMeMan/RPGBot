...
public class User {
    ...
    User(String prefix, String nick) {
        if (nick.charAt(0) == '+' || nick.charAt(0) == '%' || nick.charAt(0) == '@' || nick.charAt(0) == '&' || nick.charAt(0) == '~')
        {
            _prefix = nick.charAt(0) + "";
            _nick = nick.replace(_prefix,"");;
        }
        else
        {
            _prefix = prefix;
     ...
     */
    public boolean isOp() {
        return _prefix.equals("@") || _prefix.equals("&") || _prefix.equals("~");
    }
